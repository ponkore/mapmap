...
get the app created:
    ...
    $ heroku apps:create mapmap
    Creating mapmap... done, stack is cedar
    http://mapmap.herokuapp.com/ | git@heroku.com:mapmap.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://mapmap.herokuapp.com deployed to Heroku

    To git@heroku.com:mapmap.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://mapmap.herokuap.com
    ["Hello" :from Heroku]
